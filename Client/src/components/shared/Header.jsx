    ...
    return (
        <div className="w-full text-sm bg-white">
                ...
                <div className="max-w-screen-xl mx-auto flex justify-between items-center py-3">
                    {/* Left Part */}
                        ...
                        <div className="relative">
                            <input type="text"
                                ...
                                className="border border-gray-300 rounded px-4 py-1.5 w-[480px] text-sm outline-none pr-10"
                            />
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="text-sm font-medium cursor-pointer mt-2">
                            {loading && <img src={map} alt="loading..." className="w-10 h-10"></img>}
                            {/* {location && <p>{location?.address?.state}</p>}&#9662; */}
                            {location && <p>{location?.address?.state}</p>}<FaCaretDown size={14} />
            ...
            <div className="bg-[#f2f2f2] px-4 md:px-8">
                <div className="max-w-screen-xl mx-auto flex items-center py-2 justify-between text-gray-700">
